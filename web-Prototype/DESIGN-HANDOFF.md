# 32965cab-1243-48c2-8bea-60f98c72c0ec implementation handoff

This archive is the source of truth for turning the design into production code. Start from `hero-section-2.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `hero-section-2.html`
...
- A single self-contained `hero-section-2.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `hero-section-2.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `hero-section-2.html`
- `hero-section.html`
- `noyce-ide-cinematic-hero.html`
- `noyce-ide-hero.html`
- `noyce-ide-landing-custom-logo.html`
- `noyce-ide-landing-final.html`
- `noyce-ide-landing-full-2.html`
- `noyce-ide-landing-full-features-2.html`
- `noyce-ide-landing-full-features.html`
- `noyce-ide-landing-full.html`
- `noyce-ide-landing-new-brand-2.html`
- `noyce-ide-landing-new-brand-3.html`
- `noyce-ide-landing-new-brand.html`
- `noyce-ide-landing.html`
...
- `assets/01-project-graph.png`
- `assets/02-compliance-dashboard.png`
- `assets/03-traceability-graph.png`
- `assets/04-ai-orchestrator.png`
- `assets/05-ai-models.png`
- `assets/06-build-pipeline.png`
- `assets/07-project-templates.png`
- `assets/08-review-workflow.png`
- `assets/10-pin-configurator.png`
- `assets/11-misra-diagnostics.png`
- `assets/12-quality-trend.png`
- `assets/craft.mp4`
- `assets/featured.mp4`
- `assets/hero.mp4`
- `assets/icon.svg`
...
- `assets/strategy.mp4`
- `mr6fi2pd-icon_large.png`
- `mr6fibvg-logo_horizontal.png`
- `mr6fif0i-logo_large.png`
- `mr6ftttf-logo_horizontal.png`
- `mr6ftttg-logo_large.png`
- `mr6fu6rg-icon_large.png`

## Coding checklist for AI tools
1. Inspect `hero-section-2.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
